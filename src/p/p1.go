...
var (
	googleOauthConfig = &oauth2.Config{
		...
		//"1047409585065-f1htrjqi2pmetvubrtjogu53qdhp6mp4.apps.googleusercontent.com",
		//"150692018910-ucks0ik3udikh57v9mke4cu8bcap4ntm.apps.googleusercontent.com",
		//os.Getenv("googlekey"),
		ClientSecret: "FOQSibclgP75TdDU8HNPq3c_",
		//"ew8o84CEOXFcOml6j2TlMXcb",
		//"pMyHilWaBp-YEfPSRx9qTE6C",
