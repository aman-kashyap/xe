...
func main() {
	r := mux.NewRouter()
	people = append(people, Person{ID: "1", Firstname: "Annu", Lastname: "Parasar", Address: &Address{City: "Begusarai", State: "Bihar"}})
	people = append(people, Person{ID: "2", Firstname: "Madhulika", Lastname: "Kumari"})
