...
func cmd() *cobra.Command {
	...
	c.Flags().StringVar(&a.redirectURI, "redirect-uri", "http://localhost:8888/callback", "Callback URL for OAuth2 responses.")
	c.Flags().StringVar(&issuerURL, "issuer", "https://github.com/login/oauth/authorize", "URL of the OpenID Connect issuer.")
