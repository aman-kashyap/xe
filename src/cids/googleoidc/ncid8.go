...
const exampleAppState = "jeetega bhai jeetega"
...
func cmd() *cobra.Command {
	...
	c.Flags().StringVar(&a.clientID, "client-id", "1047409585065-k9gf8lqa8ss0b0a2hug24vu2g2g7tf9m.apps.googleusercontent.com", "OAuth2 client ID of this application.")
	c.Flags().StringVar(&a.clientSecret, "client-secret", "FOQSibclgP75TdDU8HNPq3c_", "OAuth2 client secret of this application.")
	c.Flags().StringVar(&a.redirectURI, "redirect-uri", "http://localhost:1313/GoogleCallback", "Callback URL for OAuth2 responses.")
	c.Flags().StringVar(&issuerURL, "issuer", "https://accounts.google.com", "URL of the OpenID Connect issuer.")
	c.Flags().StringVar(&listen, "listen", "http://localhost:1313", "HTTP(S) address to listen at.")
