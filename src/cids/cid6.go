...
func main() {
	...
	flag.StringVar(&oauth2Config.RedirectURL, "redirect-url", "http://localhost:1313/GoogleCallback", "A full OAuth2 redirect URL.")
	flag.StringVar(&oauth2Config.ClientID, "client-id", "1047409585065-k9gf8lqa8ss0b0a2hug24vu2g2g7tf9m.apps.googleusercontent.com", "The client ID of the OAuth2 client.")
	flag.StringVar(&oauth2Config.ClientSecret, "client-secret", "FOQSibclgP75TdDU8HNPq3c_", "The client secret of the OAuth2 client.")
	flag.StringVar(&scopes, "scopes", "openid,email,profile", `A comma seprated list of OAuth2 scopes to request ("openid" required).`)
	flag.StringVar(&allow, "allow-email", "jonnyfox007@gmail.com", "Comma seperated list of email regexp's to match for access to the backend.")
