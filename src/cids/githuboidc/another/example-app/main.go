...
func cmd() *cobra.Command {
	...
	c.Flags().StringVar(&a.clientID, "client-id", "x6c0971e3c5016f020e0f", "OAuth2 client ID of this application.")
	c.Flags().StringVar(&a.clientSecret, "client-secret", "x5dd8069b23820aaad1afb6c215f6eb5cd72f33c2", "OAuth2 client secret of this application.")
	...
	c.Flags().StringVar(&tlsCert, "tls-cert", "cert.pem", "X509 cert file to present when serving HTTPS.")
