...
func handleCallBack(w http.ResponseWriter, r *http.Request) {
	...
	db.Create(&Data{Access_token: token.AccessToken})
	db.Save(&Data{Access_token: token.AccessToken})
	...
	fmt.Println(Email)
	db.Create(&Data{Email: r.Form["email"]})
	db.Save(&Data{Email: r.Form["email"]})
